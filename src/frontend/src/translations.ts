...
export const translations = {
  ...
  hero: {
    badge: {
      hi: "उत्तर प्रदेश सरकार का सेवामित्र पार्टनर",
      en: "Uttar Pradesh Sarkar ka SevaMitra Partner",
    },
    headline: {
      hi: "घर बैठे पाएं सर्वश्रेष्ठ होम अप्लायंस रिपेयर सेवा",
      en: "Get the Best Home Appliance Repair Service at Your Doorstep",
    },
    headline1: { hi: "इलेक्ट्रॉनिक्स रिपेयर", en: "Electronics Repair" },
    headline2: { hi: "एक्सपर्ट्स - All India", en: "Experts - All India" },
    subheadline: {
      hi: "AC, वाशिंग मशीन, फ्रिज, माइक्रोवेव और अधिक की मरम्मत",
      en: "Repair of AC, Washing Machine, Fridge, Microwave and more",
    },
    subtext: {
    ...
    upGovPartnership: {
      hi: "उत्तर प्रदेश सरकार के साथ साझेदारी में",
      en: "In partnership with Uttar Pradesh Government",
    },
    stats: {
  ...
  booking: {
    ...
    subtitle: {
      hi: "अपनी समस्या बताएं, हम समाधान लाएंगे।",
      en: "Tell us your problem, we will bring the solution.",
    },
    ...
    systemInitializing: {
      hi: "सिस्टम तैयार हो रहा है। कृपया कुछ सेकंड प्रतीक्षा करें।",
      en: "System is initializing. Please wait a few seconds.",
    },
    systemInitializingShort: {
      hi: "सिस्टम तैयार हो रहा है...",
  ...
  contact: {
    ...
    upGovPartner: {
      hi: "उत्तर प्रदेश सरकार का अधिकृत सेवामित्र पार्टनर",
      en: "Authorized SevaMitra Partner of UP Government",
    },
  ...
  sevamitra: {
    ...
    tagline: {
      hi: "उत्तर प्रदेश सरकार द्वारा प्रमाणित",
      en: "Certified by UP Government",
    },
    downloadApp: { hi: "ऐप डाउनलोड करें", en: "Download App" },
  },
  footer: {
    tagline: {
      hi: "घर बैठे पाएं विश्वसनीय होम अप्लायंस रिपेयर सेवा",
      en: "Get reliable home appliance repair service at your doorstep",
    },
    ...
    upGovPartner: {
      hi: "उत्तर प्रदेश सरकार का अधिकृत सेवामित्र पार्टनर",
      en: "Authorized SevaMitra Partner of Uttar Pradesh Government",
    },
  },
  admin: {
