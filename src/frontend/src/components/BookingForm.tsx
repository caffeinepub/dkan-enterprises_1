...
const STATES = [
  'Uttar Pradesh', 'Gujarat', 'Maharashtra', 'Madhya Pradesh', 'Rajasthan', 'Bihar',
  'West Bengal', 'Karnataka', 'Tamil Nadu', 'Telangana', 'Andhra Pradesh', 'Kerala',
  'Odisha', 'Jharkhand', 'Chhattisgarh', 'Haryana', 'Punjab', 'Delhi', 'Other',
];

const serviceOptions = [
  { value: ServiceType.acRepair, labelHi: 'एसी मरम्मत', labelEn: 'AC Repair' },
  { value: ServiceType.washingMachineRepair, labelHi: 'वाशिंग मशीन मरम्मत', labelEn: 'Washing Machine Repair' },
  { value: ServiceType.refrigeratorRepair, labelHi: 'रेफ्रिजरेटर मरम्मत', labelEn: 'Refrigerator Repair' },
  { value: ServiceType.microwaveRepair, labelHi: 'माइक्रोवेव मरम्मत', labelEn: 'Microwave Repair' },
  { value: ServiceType.geyserRepair, labelHi: 'गीज़र मरम्मत', labelEn: 'Geyser Repair' },
  { value: ServiceType.lcdLedTvRepair, labelHi: 'LCD/LED TV मरम्मत', labelEn: 'LCD/LED TV Repair' },
  { value: ServiceType.waterPurifier, labelHi: 'वाटर प्यूरीफायर', labelEn: 'Water Purifier' },
];

const timeSlotOptions = [
  { value: TimeSlot.morning_9_12, labelHi: 'सुबह 9 - 12 बजे', labelEn: 'Morning 9 AM – 12 PM' },
  { value: TimeSlot.afternoon_12_4, labelHi: 'दोपहर 12 - 4 बजे', labelEn: 'Afternoon 12 PM – 4 PM' },
  { value: TimeSlot.evening_4_7, labelHi: 'शाम 4 - 7 बजे', labelEn: 'Evening 4 PM – 7 PM' },
];
...
export default function BookingForm() {
  ...
  const { mutate: createBooking, isPending, isSuccess, reset } = useCreateBooking();
          ...
          <div className="bg-card border border-border rounded-2xl p-10 text-center shadow-navy-lg">
            ...
            {bookingId !== null && (
              <p className="text-muted-foreground mb-1">
                ...
                <span className="font-mono font-semibold text-primary">#{String(bookingId)}</span>
              </p>
            )}
            ...
            <button
              onClick={() => { reset(); setBookingId(null); setSubmitError(null); }}
  ...
  const inputClass = "w-full px-4 py-3 border border-border rounded-xl bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 text-sm";
  ...
  return (
    <section id="booking" className="py-16 bg-muted/30">
      <div className="max-w-2xl mx-auto px-4">
        ...
        <form onSubmit={handleSubmit} className="bg-card border border-border rounded-2xl p-6 sm:p-8 shadow-navy-lg space-y-5">
          {/* Name */}
          <div>
          ...
          <div>
            ...
            <input
              ...
              placeholder={lang === 'hi' ? 'गली, मोहल्ला, शहर' : 'Street, locality, city'}
              className={inputClass}
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={lang === 'hi' ? 'अपनी समस्या विस्तार से बताएं...' : 'Describe your problem in detail...'}
              rows={3}
              className={inputClass}
            />
          </div>
          ...
          {submitError && (
            <div className="flex items-start gap-3 bg-destructive/10 border border-destructive/30 rounded-xl px-4 py-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-destructive/90 mt-0.5">{submitError}</p>
                <button
                  type="button"
                  onClick={handleRetry}
